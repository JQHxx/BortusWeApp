  ...
  data: {
    list: [
      ...
      },
      {
        ...
        open: false,
        pages: [
          { zh: '左右伸缩', url: 'telescopic' },
          { zh: '换行排列', url: 'linebreak' },
          { zh: '侧边导航栏', url: 'sidenavigation' },
          { zh: '分页展现', url: 'pagination' },
          { zh: '自由布局', url: 'freelayout' },
          { zh: '分层展现', url: 'layeredpresentation' },
          { zh: '横向拓展', url: 'horizontalexpansion' },
        ],
      },
    ],
    extendedList: [
