            ...
            <div class="weui-panel__bd">
                <navigator url="" class="weui-media-box weui-media-box_appmsg" hover-class="weui-cell_active">
                    <div class="weui-media-box__hd weui-media-box__hd_in-appmsg">
                        <image class="weui-media-box__thumb" v-bind:src="icon60" />
                    </div>
                ...
                <div class="weui-media-box weui-media-box_small-appmsg">
                    <div class="weui-cells weui-cells_in-small-appmsg">
                        <navigator url="" class="weui-cell weui-cell_example weui-cell_access" hover-class="weui-cell_active">
                            <div class="weui-cell__hd"><image v-bind:src="icon20" style="width: 20px;height: 20px;margin-right: 16px;vertical-align:middle;" /></div>
                        ...
                        <navigator url="" class="weui-cell weui-cell_example weui-cell_access" hover-class="weui-cell_active">
                            <view class="weui-cell__hd"><image v-bind:src="icon20" style="width: 20px;height: 20px;margin-right: 16px;vertical-align:middle;" /></view>
                            <div class="weui-cell__bd weui-cell_primary">
                                <div>文字标题</div>
                            </div>
                            <div class="weui-cell__ft weui-cell__ft_in-access"></div>
