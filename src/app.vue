...
class App implements AppOptions<WepyApp> {
  ...
  constructor() {
    this.globalData = {
      ...
      hasLogin: false,
      openid: '',
      iconTabbar: '/resources/images/icon_tabbar.png',
...
<config>
{
  "pages": [
    ...
    "page/api/login",
    "page/api/get-user-info",
    "page/api/request-payment",
    "page/api/share",
    "page/api/share-button",
    "page/api/custom-message",
    "page/api/subscribe-message",
    "page/api/choose-address",
    "page/api/choose-invoice-title",
    "page/api/soter-authentication",
    "page/api/setting",
    "page/api/set-navigation-bar-title",
    "page/api/navigation-bar-loading",
    "page/api/navigator",
    "page/api/pull-down-refresh",
    "page/api/animation",
    "page/api/action-sheet",
    "page/api/modal",
    "page/api/page-scroll",
    "page/api/toast",
    "page/api/get-network-type",
    "page/api/on-network-status-change",
    "page/api/get-system-info",
    "page/api/get-battery-info",
    "page/api/on-accelerometer-change",
    "page/api/on-compass-change",
    "page/api/make-phone-call",
    "page/api/scan-code",
    "page/api/clipboard-data",
    "page/api/bluetooth",
    "page/api/slave",
    "page/api/ibeacon",
    "page/api/screen-brightness",
    "page/api/capture-screen",
    "page/api/vibrate",
    "page/api/add-contact",
    "page/api/wifi",
    "page/api/request",
    "page/api/web-socket",
    "page/api/upload-file",
    "page/api/download-file",
    "page/api/udp-socket",
    "page/api/image",
    "page/api/audio",
    "page/api/voice",
    "page/api/background-audio",
    "page/api/file",
    "page/api/video",
    "page/api/get-location",
    "page/api/open-location",
    "page/api/choose-location",
    "page/api/storage",
    "page/api/get-background-fetch-data",
